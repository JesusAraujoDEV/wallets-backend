...
async function getIncomeHeatmap({ userId, fromDate, toDate, accountId, groupId }) {
  ...
  return { categories, weekdays: WEEKDAYS, data_points, summary: { peak_category: peakCategory || null, peak_day: peakDayIdx != null ? WEEKDAYS[peakDayIdx] : null } };
}

module.exports = { getIncomeHeatmap };
